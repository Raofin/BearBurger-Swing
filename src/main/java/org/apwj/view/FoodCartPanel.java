...
public class FoodCartPanel extends JPanel {
    public static int totalFoodNumber = 0;
    public static int totalCost = 0;

    public FoodCartPanel() {
        initComponents();
        totalFoodNumberLabel.setText(String.valueOf(totalFoodNumber));
    ...
    private void initComponents() {
        ...
        //======== panel ========
        {
            ...
            totalFoodNumberLabel.setText("01");
